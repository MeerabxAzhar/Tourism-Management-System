...
public class Userislamabad extends javax.swing.JFrame {
    ...
    DefaultTableModel d;
    public Userislamabad() {
        initComponents();
        cons.Connect();
         tabl.tbli(tbluserisl);
    }
 public void mouse() {
        d = (DefaultTableModel) tbluserisl.getModel();
        int sIndex = tbluserisl.getSelectedRow();
    ...
    private void initComponents() {
        ...
        tbluserisl = new javax.swing.JTable();
        ...
        tbluserisl.setBackground(new java.awt.Color(0, 0, 0));
        tbluserisl.setForeground(new java.awt.Color(255, 255, 255));
        tbluserisl.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbluserisl.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbluserislMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbluserisl);
        ...
        jPanel5.add(btnaddpkg, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 250, -1, -1));
    ...
    private void tbluserislMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbluserislMouseClicked
      
        mouse();
    }//GEN-LAST:event_tbluserislMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Userislamabad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Userislamabad().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tbluserisl;
