 ...
 * @author taimo
 */
public class Usermuree extends javax.swing.JFrame {
...
public void mouse() {
        d = (DefaultTableModel) tbluserkar.getModel();
        int sIndex = tbluserkar.getSelectedRow();
    ...
    private void btnaddpkgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddpkgActionPerformed
        JOptionPane.showMessageDialog(null,"The package has been booked successfully!");
 ...
 Userview view=new Userview();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Usermuree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
